...
export default function AttendancePage() {
  ...
  const socket = useWs({
    ...
    on: {
      async att_result(...args: unknown[]) {
        ...
        for (const block of blocked) {
          ...
          if (blockData.code === 'cooldown' && blockData.until_formatted && blockData.remaining_sec !== undefined) {
            ...
            // Dynamic import for formatDuration
      ...
      att_log_snapshot(...args: unknown[]) {
        const __data = args[0] as unknown;
  ...
  }, [cameraActive, baseInterval.model, pushAttFrame]);
