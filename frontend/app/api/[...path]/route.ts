...
// Handler untuk semua HTTP methods - DIPERBAIKI: params sebagai Promise
export async function GET(
  request: NextRequest,
  { params }: { params: Promise<{ path: string[] }> } // ✅ DIPERBAIKI
) {
...
async function handleRequest(
  request: NextRequest,
  params: Promise<{ path: string[] }> // ✅ DIPERBAIKI: params sebagai Promise
) {
  try {
    const backendUrl = getBackendUrl();
    const { path: pathSegments } = await params; // ✅ DIPERBAIKI: await params
