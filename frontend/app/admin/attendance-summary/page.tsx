...
export default function AdminAttendanceSummaryPage() {
  ...
  // Date range for filtering (available for future date filtering feature)
  ...
  const formatMonthLabel = useCallback((period: string): string => {
    if (!period) return "-";
  ...
  }, [summaryState.data?.monthly, chartSeries, formatMonthLabel]);
